...
/**
 * Video Game Achievement Manager!
 * <p>
 * This program allows users to track the video games they're playing and monitor their achievement progress.
 * Users can add, remove, update, and display their video game titles along with the total number of achievements,
 * the number of achievements completed, and the overall completion percentage. Data can be managed manually or in bulk via text/CSV files.
 * </p>
 * <p>
 * This class houses the main entry point for the application. It prompts the user for MySQL database connection details,
 * including host, port, database name, username, and password. It also prompts the user for their UserID before launching the GUI.
 * </p>
 */
public class Main {
