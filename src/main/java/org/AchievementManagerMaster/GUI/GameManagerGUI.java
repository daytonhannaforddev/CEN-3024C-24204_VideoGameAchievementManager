...
/**
 * Graphical User Interface for the Video Game Achievement Manager.
 * <p>
 * This class houses the GUI for my Video Game Achievement Manager application.
 * It enables users to add, remove, update, import games, and logout to re-enter a different UserID.
 * </p>
 */
public class GameManagerGUI extends JFrame {
    ...
    /**
     * Refreshes the game list in the table.
     * <p>
     * Retrieves the games for the current user and updates the table model.
     * If no games are found, an informational message is displayed.
     * </p>
     */
    ...
    /**
     * Prompts the user for a valid UserID.
     * <p>
     * Continues to prompt until a valid integer is entered.
     * </p>
     *
     * @return the valid UserID entered by the user
     */
    ...
    /**
     * Displays a dialog to add a new game.
     * <p>
     * Prompts the user to enter game details and then attempts to add the game.
     * </p>
     */
    ...
    /**
     * Displays a dialog to remove selected games.
     * <p>
     * Allows the user to select one or more games from the table and confirms deletion.
     * </p>
     */
    ...
    /**
     * Displays a dialog to update an existing game's details.
     * <p>
     * Prompts the user to modify the details of the selected game and then updates it.
     * </p>
     */
    ...
    /**
     * Displays a file chooser dialog to import games in bulk.
     * <p>
     * Allows the user to select a file and then imports games from the selected file.
     * </p>
     */
